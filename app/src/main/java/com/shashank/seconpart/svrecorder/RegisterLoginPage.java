...
public class RegisterLoginPage extends AppCompatActivity {
    ...
    Button btn_login, btn_logout,btn_sv;
    TextView textfire;
    ImageView imagefire,imagefireCopy;
    ...
    public void callRecordActivity(){
        ...
        try {
            ...
            if(TextUtils.isEmpty(edtEmailstr)) {
                Toast.makeText(RegisterLoginPage.this,"Enter your mail id first",Toast.LENGTH_LONG).show();
            }
            else{

                Intent intent = new Intent(RegisterLoginPage.this, RecordActivity.class);
                intent.putExtra("Key", edtEmailstr);
